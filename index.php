...
<div id="Portfolio_Detail_comutitres" class="modal">
    <div class="modal-content">
        <a href="javascript:void(0)"
           class="modal-action modal-close close btn-floating btn waves-effect waves-teal white"><i
                    class="material-icons light-green-text text-darken-3">close</i></a>
    ...
    <div class="modal-footer">
        <a href="https://www.jegeremacartenavigo.fr/touslesservices"
           class="waves-effect btn-flat left light-green-text text-darken-3">MORE INFO</a>
    </div>
</div>
...
<div id="Portfolio_Detail_samsung" class="modal">
    <div class="modal-content">
        ...
        <img src="images/Portfolio/realisations_web/betd/offres.samsung.fr_promotion.png" class="responsive-img"
             alt="ODR Samsung">
        <hr>
        <p>
            Projet de build pour le client SAMSUNG :
            <br>- Refonte d'un outil de configuration de promotions dématérialisées pour Samsung
            (https://offre.samsung.com)
    ...
    <div class="modal-footer">
        <a href="https://offres.samsung.fr" class="waves-effect btn-flat left light-green-text text-darken-3">MORE
            INFO</a>
    </div>
</div>
<!-- # Portfolio Detail Modal End # -->
...
<div id="Portfolio_Detail_umanager" class="modal">
    <div class="modal-content">
        ...
        <img src="images/Portfolio/realisations_web/umanager2.png" class="responsive-img"
             alt="Interface de gestion de sauvegarde">
        <hr>
...
<div id="Portfolio_Detail_bat" class="modal">
    <div class="modal-content">
        ...
        <img src="images/Portfolio/realisations_web/roto2.jpg" class="responsive-img"
             alt="Outil de Bon à tirer en ligne">
        <hr>
        <p>Outil intégrant automatiquement des editions à imprimer (déposés sur un FTP, detectés avec Inotify). Les
            clients ont la possibilité de valider ou refus chaque page ; un compte rendu est ensuite envoyé par mail
            pour lancer l'impression.</p>
    </div>
    <div class="modal-footer">
        <!--<a href="#!" class="waves-effect btn-flat left light-green-text text-darken-3">MORE INFO</a>-->
        <a href="https://webextranet.rotopicardie.fr/" target="_blank"
           class="waves-effect btn-flat right light-green-text text-darken-3">VOIR</a>
    </div>
</div>
<!-- # Portfolio Detail Modal End # -->
<!-- Portfolio Detail Modal -->
<div id="Portfolio_Detail_rotostock" class="modal">
    <div class="modal-content">
        ...
        <img src="images/Portfolio/realisations_web/rotostock2.jpg" class="responsive-img"
             alt="Outil de Gestion de stock">
        <hr>
        <p>Outil de suivi du stock. Saisie rapide avec systeme de douchette ; Eport Excel de l'etat du stock et de la
            consommation sur une période.</p>
    </div>
    <div class="modal-footer">
        <!--<a href="#!" class="waves-effect btn-flat left light-green-text text-darken-3">MORE INFO</a>-->
...
<div id="Portfolio_Detail_suiviactivite" class="modal">
    <div class="modal-content">
        ...
        <img src="images/Portfolio/realisations_web/suivi_activite_2.png" class="responsive-img"
             alt="App Suivi Activité">
        <hr>
        <p>Application mobile permettant aux salariés de renseigner leur activité quotidienne, et le temps passé auprès
            des clients.</p>
    </div>
    <div class="modal-footer">
        <!--<a href="#!" class="waves-effect btn-flat left light-green-text text-darken-3">MORE INFO</a>-->
...
<div id="Portfolio_Detail_ofre" class="modal">
    <div class="modal-content">
        ...
        <img src="images/Portfolio/realisations_web/ofre-formation-2.png.jpg" class="responsive-img"
             alt="Outil de Gestion de Planning de formation">
        <hr>
        <p>Outil permettant de gérer des formations et plannings associés.</p>
    </div>
    <div class="modal-footer">
        <!--<a href="#!" class="waves-effect btn-flat left light-green-text text-darken-3">MORE INFO</a>-->
        <a href="https://www.ofre-formation.com/plannings/" target="_blank"
           class="waves-effect btn-flat right light-green-text text-darken-3">VOIR</a>
    </div>
</div>
<!-- # Portfolio Detail Modal End # -->
...
<div id="Portfolio_Detail_gestparc" class="modal">
    <div class="modal-content">
        ...
        <img src="images/Portfolio/realisations_web/gestparc-2.jpg" class="responsive-img"
             alt="Outil de Gestion de Parc automobile">
        <hr>
        <p>Outil permettant de gérer des un parc automobile, les problémes d'equipement, les accidents et révisions à
            planifier.</p>
    </div>
    <div class="modal-footer">
        <!--<a href="#!" class="waves-effect btn-flat left light-green-text text-darken-3">MORE INFO</a>-->
        <a href="http://gestparcspta.plug-it.com" target="_blank"
           class="waves-effect btn-flat right light-green-text text-darken-3">VOIR</a>
    </div>
</div>
<!-- # Portfolio Detail Modal End # -->
...
<div id="Portfolio_Detail_docamsam" class="modal">
    ...
    <div class="modal-footer">
        <!--<a href="#!" class="waves-effect btn-flat left light-green-text text-darken-3">MORE INFO</a>-->
        <a href="https://documentation.amsam-02.com/" target="_blank"
           class="waves-effect btn-flat right light-green-text text-darken-3">VOIR</a>
    </div>
</div>
<!-- # Portfolio Detail Modal End # -->
...
<div id="Portfolio_Detail_aestheticgroup" class="modal">
    <div class="modal-content">
        ...
        <img src="images/Portfolio/realisations_web/aesthetic-2.jpg" class="responsive-img"
             alt="Boutique Aesthetic Group">
        <hr>
        <p>Site mis en place sous Prestashop.</p>
    </div>
    <div class="modal-footer">
        <!--<a href="#!" class="waves-effect btn-flat left light-green-text text-darken-3">MORE INFO</a>-->
        <a href="https://www.aestheticgroup.fr" target="_blank"
           class="waves-effect btn-flat right light-green-text text-darken-3">VOIR</a>
    </div>
</div>
<!-- # Portfolio Detail Modal End # -->
...
<div id="Portfolio_Detail_marcelhartmann" class="modal">
    ...
    <div class="modal-footer">
        <!--<a href="#!" class="waves-effect btn-flat left light-green-text text-darken-3">MORE INFO</a>-->
        <a href="http://www.marcelhartmann.fr/" target="_blank"
           class="waves-effect btn-flat right light-green-text text-darken-3">VOIR</a>
    </div>
</div>
<!-- # Portfolio Detail Modal End # -->
...
<div id="Portfolio_Detail_tervia" class="modal">
    ...
    <div class="modal-footer">
        <!--<a href="#!" class="waves-effect btn-flat left light-green-text text-darken-3">MORE INFO</a>-->
        <a href="http://www.tervia.fr/" target="_blank"
           class="waves-effect btn-flat right light-green-text text-darken-3">VOIR</a>
    </div>
</div>
<!-- # Portfolio Detail Modal End # -->
...
<div id="Portfolio_Detail_latangente" class="modal">
    ...
    <div class="modal-footer">
        <!--<a href="#!" class="waves-effect btn-flat left light-green-text text-darken-3">MORE INFO</a>-->
        <a href="http://www.latangente.band/" target="_blank"
           class="waves-effect btn-flat right light-green-text text-darken-3">VOIR</a>
    </div>
</div>
<!-- # Portfolio Detail Modal End # -->
...
<div id="Portfolio_Detail_spta" class="modal">
    ...
    <div class="modal-footer">
        <!--<a href="#!" class="waves-effect btn-flat left light-green-text text-darken-3">MORE INFO</a>-->
        <a href="http://www.spta.fr/" target="_blank"
           class="waves-effect btn-flat right light-green-text text-darken-3">VOIR</a>
    </div>
</div>
<!-- # Portfolio Detail Modal End # -->
...
<div id="Portfolio_Detail_ecab80" class="modal">
    ...
    <div class="modal-footer">
        <!--<a href="#!" class="waves-effect btn-flat left light-green-text text-darken-3">MORE INFO</a>-->
        <a href="http://www.ecab80.fr/" target="_blank"
           class="waves-effect btn-flat right light-green-text text-darken-3">VOIR</a>
    </div>
</div>
<!-- # Portfolio Detail Modal End # -->
...
<div id="Portfolio_Detail_leflightcase" class="modal">
    ...
    <div class="modal-footer">
        <!--<a href="#!" class="waves-effect btn-flat left light-green-text text-darken-3">MORE INFO</a>-->
        <a href="http://www.leflightcase.fr/" target="_blank"
           class="waves-effect btn-flat right light-green-text text-darken-3">VOIR</a>
    </div>
</div>
<!-- # Portfolio Detail Modal End # -->
...
<div id="Portfolio_Detail_picabou" class="modal">
    ...
    <div class="modal-footer">
        <!--<a href="#!" class="waves-effect btn-flat left light-green-text text-darken-3">MORE INFO</a>-->
        <a href="http://www.picabou.fr/" target="_blank"
           class="waves-effect btn-flat right light-green-text text-darken-3">VOIR</a>
    </div>
</div>
<!-- # Portfolio Detail Modal End # -->
...
<div id="Portfolio_Detail_exgtransfert" class="modal">
    ...
    <div class="modal-footer">
        <!--<a href="#!" class="waves-effect btn-flat left light-green-text text-darken-3">MORE INFO</a>-->
        <a href="http://www.exg-transfert.com" target="_blank"
           class="waves-effect btn-flat right light-green-text text-darken-3">VOIR</a>
    </div>
</div>
<!-- # Portfolio Detail Modal End # -->
...
<div id="Portfolio_Detail_monitoring" class="modal">
    <div class="modal-content">
        ...
        <img src="images/Portfolio/realisations_web/4e70918c-e54f-11e2-a77d-22000aa5129e-large.jpg"
             class="responsive-img" alt="Monitoring">
        <hr>
        <p>-</p>
    </div>
    <div class="modal-footer">
